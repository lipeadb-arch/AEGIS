...
> **Propósito deste arquivo:** reinjeção de contexto exato em futuras sessões de IA, sem reler o código-fonte. Não é documentação comercial. Última atualização: **2026-07-22**.
>
...
>
> **Em andamento nesta branch (`fix/aud-046-sanitize-demo-data`):** **AEGIS-AUD-046** — saneamento de dados de demonstração reais/identificáveis em stubs, seeds, testes e frontend, substituídos por uma organização sintética (`demo.example.com` / `example.com`) e um cenário determinístico equivalente. Contratos, payloads, scoring e cobertura de testes preservados; sem migration.
>
