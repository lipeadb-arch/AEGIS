...
export const NIST_FUNCTION_DESCRIPTIONS: Record<NistFunctionCode, string> = {
  ...
  DE: 'Desenvolvimento e implementação de atividades para identificar a ocorrência de um evento de segurança cibernética. O Aegis reúne a evidência disponível sobre essa capacidade — regras e fontes configuradas não comprovam, sozinhas, que ameaças reais seriam detectadas a tempo.',
