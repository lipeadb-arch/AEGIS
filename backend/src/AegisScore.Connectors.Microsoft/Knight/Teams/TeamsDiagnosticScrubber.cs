...
/// <summary>
/// [AEGIS-KNIGHT-COVERAGE-02] Sanitização do DIAGNÓSTICO que sai do processo de coleta.
///
...
///   1. os segredos CONHECIDOS desta coleta (os dois tokens que o próprio AEGIS acabou de entregar ao processo)
