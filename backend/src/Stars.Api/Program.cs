...
using Stars.Connectors.Microsoft;
using Stars.Infrastructure;
...
builder.Services.AddSwaggerGen(o => o.SwaggerDoc("v1", new() { Title = "S.T.A.R.S API", Version = "v1" }));
...
{
    var db = scope.ServiceProvider.GetRequiredService<StarsDbContext>();
