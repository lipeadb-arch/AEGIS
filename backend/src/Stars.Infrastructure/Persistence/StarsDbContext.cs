...
namespace Stars.Infrastructure.Persistence;

/// <summary>
/// The S.T.A.R.S database context (PostgreSQL via Npgsql).
...
public class StarsDbContext : DbContext
{
    ...
    public StarsDbContext(DbContextOptions<StarsDbContext> options, ITenantContext tenant)
