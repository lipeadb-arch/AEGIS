...
public static class KnightControlImpacts
{
    private static readonly IReadOnlyDictionary<string, string> ById = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["AK-TEAMS-009"] = "Uma reunião recorrente da organização pode ser aberta por terceiros fora do horário previsto e usada como sala de encontro sem supervisão de ninguém de dentro.",
        ...
        ["AK-TEAMS-013"] = "Um participante pode exibir conteúdo indevido a todos os presentes ou interromper a reunião removendo outras pessoas, inclusive em encontros com participantes externos.",
        ...
        ["AK-TEAMS-015"] = "Um colaborador convidado para uma reunião externa pode receber, pelo chat dela, links e arquivos enviados por participantes que a organização não conhece.",
        ...
        ["AK-TEAMS-017"] = "Uma campanha de golpe por chat pode atingir várias pessoas antes de qualquer registro chegar à equipe de segurança, porque não existe o botão que transformaria a suspeita em alerta.",
