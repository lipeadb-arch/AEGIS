...
/// fontes de evidência esperadas) — rubricas AUTORAIS do AEGIS, derivadas do NIST SP 800-53 Rev 5 — que
/// ancoram a redação da IA em vez do palpite do modelo.
///
...
/// data GLOBAL (sem tenant). Devolve <c>null</c> quando a subcategoria não tem regra (as 7 subcategorias de
/// GOVERN não automatizadas), e o avaliador degrada limpo para a definição pura da subcategoria.
/// </summary>
